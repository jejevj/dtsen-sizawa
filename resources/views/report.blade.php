                    ...
                    <div class="card card-shadow-sm ">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <div class="card-toolbar">
                                    ...
                                    <a href="{{ route('report') }}" class="btn btn-sm btn-danger">Reset Filter</a>
                                </div>
                                <!--end::Menu-->
                            </div>
                            <!--end::Toolbar-->
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="m-0">
                                    <!--begin::Heading-->
                                    <div class="accordion accordion-icon-collapse" id="kt_job_8">
                                        <div class="row">
                                            <div class="col-9">
                                            ...
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div id="kt_job_8_1" class="show collapse fs-6 ms-1" data-bs-parent="#kt_job_8">
                                                <div id="kt_job_skala1" class="fs-6 ms-1 mb-3">
                                        ...
                                        <div class="m-0 mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="d-flex align-items-center py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div id="kt_job_8_2" class="collapse fs-6 ms-1" data-bs-parent="#kt_job_8">
                                                <div id="kt_job_ktp1" class="fs-6 ms-1 mb-5">
                                                    <select class="form-select" data-control="select2"
                                                        data-placeholder="-- Provinsi --" id="provinsi_ktp"
                                                        name="provinsi_ktp">
                                                        <option value="">-- Provinsi --</option>
                                                        @foreach($data['provinsiList'] as $p)
                                                            <option value="{{ $p->provinsi_kode }}">{{ $p->provinsi_nama }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="m-0 mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    ...
                                                    <div class="btn btn-sm btn-icon mw-20px btn-active-color-primary me-5">
                                                        ...
                                                        <!--end::Icon-->
                                                        <!--begin::Title-->
                                                        <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">Wilayah
                                                            Domisili
                                                            Penerima
                                                            Manfaat
                                                        </h4>
                                            ...
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div id="kt_domisili_8_2" class="collapse fs-6 ms-1" data-bs-parent="#kt_job_8">
                                                <div id="kt_job_ktp1" class="fs-6 ms-1 mb-5">
                                                    <select class="form-select" data-control="select2"
                                        ...
                                        <div class="m-0 mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    ...
                                                    <div class="btn btn-sm btn-icon mw-20px btn-active-color-primary me-5">
                                                        ...
                                                        <!--end::Icon-->
                                                        <!--begin::Title-->
                                                        <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">Data Diri
                                                            Penerima
                                                            Manfaat
                                                        </h4>
                                                        <!--end::Title-->
                                            ...
                                            <!--begin::Body-->
                                            <div id="kt_datadiri_8_2" class="collapse fs-6 ms-1" data-bs-parent="#kt_job_8">
                                                <div id="kt_job_ktp1" class="fs-6 ms-1 mb-5">
                                        ...
                                        <div class="m-0 mt-3">
                                            ...
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div id="kt_datadiri_8_9" class="collapse fs-6 ms-1" data-bs-parent="#kt_job_8">
                                                <div class="fs-6 ms-1 mb-5">
                                                    <select class="form-select" data-control="select2"
                                                ...
                                                <div id="kt_job_ktp1" class="fs-6 ms-1 mb-5">
                                                    <input type="text" class="form-control" name="nama_program"
                                                        id="nama_program" aria-describedby="helpId"
                                                        placeholder="Nama Program" />
                                                </div>
                                                <div class="fs-6 ms-1 mb-5">
                                                    <select class="form-select" data-control="select2"
                                                        data-placeholder="-- Tipe Program --" name="tipe_program"
                                                        id="tipe_program">
                                                        <option></option>
